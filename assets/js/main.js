...
function initStreamPage() {
  ...
  const sample = [
    ['UserPro','Boa jogada!'], ['AnaH','Manda salve aí 🔥'],
    ['DevTester','Que UI bonita esse site 👀'], ['GamerX','LETSGOOO'],
    ['Luna','primeira vez aqui, gostei demais'], ['Mod_Bot','Lembrem das regras do chat.'],
  ];
  let i = 0;
  const tick = () => {
    if (!msgs) return;
